...
namespace FPTStore.DataAccess.Migrations
{
    ...
    [Migration("20231221025123_addProductImagesDb")]
    partial class addProductImagesDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FPTStore.Models.Company", b =>
                {
            ...
            modelBuilder.Entity("FPTStore.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("FPTStore.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FPTStore.Models.ProductImage", b =>
                {
            ...
            modelBuilder.Entity("FPTStore.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("FPTStore.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FPTStore.Models.OrderDetail", b =>
                {
                    b.HasOne("FPTStore.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FPTStore.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("FPTStore.Models.OrderHeader", b =>
                {
                    b.HasOne("FPTStore.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FPTStore.Models.ApplicationUser", b =>
                {
                    b.HasOne("FPTStore.Models.Company", "Company")
                        .WithMany()
